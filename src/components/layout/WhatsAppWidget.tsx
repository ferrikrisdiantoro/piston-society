...
export function WhatsAppWidget({ whatsappNumber }: WhatsAppWidgetProps = {}) {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div className="bg-white rounded-xl shadow-lg px-4 py-2.5 flex items-center gap-3 border border-[#E2E8F0] max-w-[220px]">
        <p className="text-xs text-[#1E293B] font-semibold leading-tight">
      ...
      <div className="relative">
        ...
        <a
          ...
          className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#20BA5C] hover:shadow-xl transition-all duration-200 hover:scale-110"
