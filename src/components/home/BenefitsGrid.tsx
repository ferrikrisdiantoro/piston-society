      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 id="benefits-heading" className="text-[#1E293B] mb-4">
            Everything Included.{' '}
            <span className="text-[#E85D2A]">Zero Surprises.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((benefit) => {
            ...
            return (
              <div
                key={benefit.title}
                className="p-6 rounded-2xl border border-[#E2E8F0] hover:border-[#1E3A5F]/30 hover:shadow-lg transition-all duration-300 group card-hover"
              >
                ...
                <h3 className="text-[#1E293B] font-bold text-lg mb-2 group-hover:text-[#1E3A5F] transition-colors">
                  {benefit.title}
                </h3>
